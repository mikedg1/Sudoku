...
import cz.romario.opensudoku.gui.Changelog;
...
public class FolderListActivity extends SudokuBaseListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		GoogleAdView adView = (GoogleAdView) findViewById(R.id.folderlist_adview);
        AdSenseSpec adSenseSpec =
            new AdSenseSpec(PrivateConstants.CLIENT_ID)     // Specify client ID. (Required)
            .setCompanyName(PrivateConstants.COMPANY_NAME)  // Set company name. (Required)
            .setAppName(PrivateConstants.APP_NAME)          // Set application name. (Required)
            .setKeywords(PrivateConstants.KEYWORDS)         // Specify keywords.
            .setChannel(PrivateConstants.CHANNEL_ID)        // Set channel ID.
            .setAdType(AdType.TEXT)        // Set ad type to Text.
            .setAdTestEnabled(PrivateConstants.TEST_ENABLED);       // Keep true while testing.
